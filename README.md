...
- 🎯 Entry points to execute your program using `python -m <env_fields>` or `$ env_fields` with basic CLI argument parsing.
...
```py
from env_fields import BaseClass
from env_fields import base_function
